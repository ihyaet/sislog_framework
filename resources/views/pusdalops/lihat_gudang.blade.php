                      ...
                      <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                          <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                             <a href="" class="btn"> <div class="h5 mb-0 font-weight-bold text-gray-800">GUDANG PAKEM</div></a>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-primary shadow h-100 py-2">
                          <div class="card-body">
                            <div class="row no-gutters align-items-center">
                              <div class="col mr-2">
                               <a href="" class="btn"> <div class="h5 mb-0 font-weight-bold text-gray-800">GUDANG BANTUL</div></a>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-xl-3 col-md-6 mb-4">
                          <div class="card border-left-primary shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                 <a href="" class="btn"> <div class="h5 mb-0 font-weight-bold text-gray-800">GUDANG SLEMAN</div></a>
                                </div>
                              </div>
                            </div>
                          </div>
